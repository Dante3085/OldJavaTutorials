...
public class LayoutTest extends JFrame {
	...
	LayoutTest() {
		...
		a.setMnemonic(KeyEvent.VK_R);													//Hotkey wird akitiviert, wenn ALT + gesetzer Hotkey gleichzeitig gedrückt werden. Man sieht auch, dass der mit einem Hotkey versehene Button einen unterstrichenen Buchstaben hat.
		add(a);
